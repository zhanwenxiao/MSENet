...
import torch_points3d.third_party.pointnet2.pointnet2_utils as pointnet2_utils
import torch_points3d.third_party.pointnet2.pytorch_utils as pt_utils
...
class PointnetSAModuleVotes(nn.Module):
    ...
    def forward(
        ...
        if self.pooling == "max":
            ...
            rbf = torch.exp(
                -1
                * grouped_xyz.pow(2).sum(1, keepdim=False)
                / (self.sigma**2)
                / 2
            )  # (B, npoint, nsample)

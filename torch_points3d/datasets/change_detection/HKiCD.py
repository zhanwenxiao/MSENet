...
from torch_points3d.metrics.hkiCD_tracker import hkiCDTracker
from torch_points3d.datasets.helper_ply import write_ply
    ...
    def get_tracker(self, wandb_log: bool, tensorboard_log: bool, full_pc=False, full_res=False):
        """Factory method for the tracker
            ...
            Returns:
                [BaseTracker] -- tracker
            """
        return hkiCDTracker(self, wandb_log=wandb_log, use_tensorboard=tensorboard_log,

...
class Trainer:
    ...
    def _initialize_trainer(self):
        ...
        self._tracker: BaseTracker = self._dataset.get_tracker(self.wandb_log, self.tensorboard_log, self.tracker_options.full_pc, self.tracker_options.full_res)
        ...
        for epoch in range(self._checkpoint.start_epoch, self._cfg.training.epochs):
            ...
            if self._cfg.training.optim.early_stop >= 0:
                if val_miou_ch>max_iou_ch:
                    ...
                    cpt_earlyStop += 1
                if cpt_earlyStop >= self._cfg.training.optim.early_stop:
                    break
    ...
    def _test_epoch(self, epoch, stage_name: str):
        ...
        for loader in loaders:
            ...
            if not self._dataset.has_inst_labels(stage_name) and not self.tracker_options.get(
            ...
            metric_earlystop += metrics["{}_change_miou_ch".format(stage_name)]
        return metric_earlystop/len(loaders)
